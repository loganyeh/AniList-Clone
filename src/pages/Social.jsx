            ...
            <div className="relative">
                ...
                <div id='profile-body' className='h-full w-full flex flex-row border-t-1 border-gray-300 bg-gray-200'>
                    ...
                    <div id="list-div" className='h-50 w-59 flex flex-col mt-8 mr-16'>
                        <div className='h-1/12 w-full flex items-center text-lg text-gray-500'>Social</div>
                        {/* INNER NESTED */}
                        <div className='h-11/12 w-full flex flex-col justify-around mt-2'>
                        <span className='h-8 w-full flex items-center pl-3 text-gray-600 font-semibold bg-white rounded'>Following</span>
                        <span className='h-8 w-full flex items-center pl-3 text-gray-500'>Followers</span>
                        <span className='h-8 w-full flex items-center pl-3 text-gray-500'>Forum Threads</span>
                        <span className='h-8 w-full flex items-center pl-3 text-gray-500'>Forum Comments</span>
                        </div>
                    </div>
